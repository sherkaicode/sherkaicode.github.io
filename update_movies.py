...
class MovieUpdaterApp(TkinterDnD.Tk):
    def __init__(self):
        super().__init__()
    ...
    def create_widgets(self):
        # --- TITLE ---
        lbl_title = tk.Label(self, text="Add New Movie", font=("Arial", 14, "bold"))
        ...
        # 1. Title Input
        tk.Label(form_frame, text="Movie Title:", anchor="w").pack(fill="x")
        self.entry_title = tk.Entry(form_frame)
        self.entry_title.pack(fill="x", pady=(0, 10))

        # 2. Genre Input
        tk.Label(form_frame, text="Genre (e.g. Sci-Fi, Drama):", anchor="w").pack(fill="x")
        self.entry_genre = tk.Entry(form_frame)
        self.entry_genre.pack(fill="x", pady=(0, 10))
        ...
        # 4. Description Input
        tk.Label(form_frame, text="Description/Review:", anchor="w").pack(fill="x")
        self.text_desc = tk.Text(form_frame, height=4, font=("Arial", 10))
        self.text_desc.pack(fill="x", pady=(0, 10))

        # --- DRAG AND DROP ZONE ---
        tk.Label(self, text="Movie Poster (Drag & Drop):", font=("Arial", 10, "bold")).pack(pady=(10, 5))
        ...
        # --- SAVE BUTTON ---
        btn_save = tk.Button(self, text="SAVE MOVIE", bg="#f2c94c", fg="black", font=("Arial", 10, "bold"), command=self.save_entry)
    ...
    def save_entry(self):
        ...
        if not self.current_image_path:
            messagebox.showwarning("Missing Image", "Please drag and drop a poster.")
            return
